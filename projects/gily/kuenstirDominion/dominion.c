...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case smithy:
		return (smithyFunc(currentPlayer, state));
    ...
    case great_hall:
		return(great_hallFunc(currentPlayer, state));
    ...
    case outpost:
		return(outpostFunc(currentPlayer, state));
    ...
    case sea_hag:
	return(sea_hagFunc(currentPlayer, state));
